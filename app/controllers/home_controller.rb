    ...
    @projects = [
      {
        ...
        'tags': [
          {'name': 'AWS (EC2, S3, API Gateway, SES, SQS, Route53)', 'color': 'bg-primary'},
...

      {
        ...
        'tags': [
          {'name': 'Ruby on Rails', 'color': 'bg-primary'},
          {'name': 'Ruby', 'color': 'bg-primary'},
...

      {
        ...
        'tags': [
          {'name': 'Kotlin', 'color': 'bg-primary'},
          {'name': 'Android Studio', 'color': 'bg-primary'},
